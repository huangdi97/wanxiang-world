...
- `LineageNode`  : a world definition / worldline / derived world node.
- `LineageEdge`  : a directed derivation edge (fork | promotion).
- `LineageGraph` : small in-memory DAG store with ancestor/descendant/common-
  ancestor queries and cycle rejection.
"""
