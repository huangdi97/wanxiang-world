...
| Metric | Count |
|---|---|
| Production files | 526 |
| Production LOC | 57452 |
| Public classes | 1152 |
...
| M91 | 3 | PatternObservation, PatternStatistics and PatternObservationStore are immutable, rebuildable views over committed history; detectors and candidates must consume this cache without creating a second history. | derived cache only; event refs and rebuild determinism; no automatic Candidate or canonical mutation |
