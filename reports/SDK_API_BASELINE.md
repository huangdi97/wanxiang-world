...
- `wanxiang_substrate.BodyCondition`
- `wanxiang_substrate.BodyConstraintViolation`
- `wanxiang_substrate.BodyError`
...
- `wanxiang_substrate.CONFIDENCE_GAIN_PER_PRACTICE`
- `wanxiang_substrate.CONFIDENCE_MAX`
- `wanxiang_substrate.CONFIDENCE_MIN`
- `wanxiang_substrate.CONFIDENCE_REGRESS_FAIL`
- `wanxiang_substrate.CONTAINED_COMPONENT`
- `wanxiang_substrate.CONTAINER_COMPONENT`
