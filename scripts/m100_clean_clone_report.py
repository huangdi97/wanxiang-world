"""Markdown rendering for the G103D isolated clean-clone artifact."""
...
def render_report(payload: dict[str, Any], rows: str) -> str:
    """Render the human-readable G103D report from the machine artifact."""
    return f"""# M100 G103D Isolated Clean Clone
